...
*** REVISION NOTES:
    ...
    This now uses nested if statements.
    
    This doesn't really reduce the complexity of the code
    or the opportunity for introducing a bug (typos in calculations).
    
    Can you think of a simpler way to code it so that you only need
    2 very simple if statements?  (Hint: think of the base price of a 
    ticket and updating its value based on the options chosen by the 
    cinema customer)
